...
DATABASES = {
    'default': {
        ...
        'USER': 'YOUR_DB_USER',                      # Not used with sqlite3.
        'PASSWORD': 'YOUR_DB_PASS',                  # Not used with sqlite3.
...
STATIC_ROOT = '/home/hipaulshi/django/static'
...
SECRET_KEY = 'savkgy8qup^(9rxi)8=h^_&amp;ov7zgi!g51b#!edyj5@dg@l77(g'
